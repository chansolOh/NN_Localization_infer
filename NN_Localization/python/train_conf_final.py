...
def compute_loss(data,model,loc_crit,rot_crit, loc_conf_crit, rot_conf_crit):
    ...
    loss = 1.2*loc_loss + rot_loss + loc_conf_loss + rot_conf_loss

    return loss, loc_loss,rot_loss, loc_conf_loss, rot_conf_loss
...
def main():
    ...
    model_name = f"GSC_C_{wandb.config.augmentation}_{wandb.config.dataset}_final"
